...
for i in range(df.shape[0]):
    plt.text(df["pop_density"].iloc[i] + 0.01,
             ...
             fontname="Arial",
             color='black')
plt.title("Analysis 1: Which Area Would Most Benefit from Transit Investment?", fontsize=14, fontweight='bold', fontname="Arial")
...
plt.grid(True)
plt.savefig("analysis1.png", dpi=300, bbox_inches='tight')